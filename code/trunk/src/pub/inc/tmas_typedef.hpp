...
class PktCapturer;
class PktDispatcher;
class PktDistributor;
class PktEntry;
class PktInfo;
class PktReceiver;

typedef boost::shared_ptr<BasicConfigParser>	BasicConfigParserSP;
typedef boost::shared_ptr<HttpFilterManager>	HttpFilterManagerSP;
...
typedef boost::shared_ptr<Logger>				LoggerSP;
typedef boost::shared_ptr<PktCapturer>			PktCapturerSP;
typedef boost::shared_ptr<PktDispatcher>		PktDispatcherSP;
typedef boost::shared_ptr<PktEntry>				PktEntrySP;
typedef boost::shared_ptr<PktInfo>				PktInfoSP;
typedef boost::shared_ptr<PktReceiver>			PktReceiverSP;
typedef boost::shared_ptr<PktDistributor>		PktDistributorSP;

typedef std::vector<PktReceiverSP> PktReceiverVec;
typedef std::vector<PktDistributorSP> PktDistributorVec;
