...
public:
	...
	// 报文处理入口
	void ProcessPacket(const PktMsg* pkt_msg);
...
private:
	...
	// 状态处理函数
	void SessionInitProc(const PktMsg* pkt_msg);
	void RecvingRequestHeaderProc(const PktMsg* pkt_msg);
	void RecvingRequestDataProc(const PktMsg* pkt_msg);
	void RecvedRequestProc(const PktMsg* pkt_msg);
	void RecvingResponseHeaderProc(const PktMsg* pkt_msg);
	void RecvingResponseDataProc(const PktMsg* pkt_msg);
	void RecvedResponseProc(const PktMsg* pkt_msg);
