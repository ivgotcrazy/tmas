/*
通过PF_PACKET，发送tcp报文， 发送的报文不需要进过协议栈，减少了开销，能提高系统发包速率
*/
...
0x2e, 0x31, 0x36, 0x38, 0x2e, 0x31, 0x2e, 0x33, 0x31, 0x3a, 0x39, 0x30, 0x39, 0x30, 0x0d, 0x0a,
...
0x32, 0x3a, 0x33, 0x39, 0x3a, 0x33, 0x38, 0x20, 0x47, 0x4d, 0x54, 0x0d, 0x0a, 0x43, 0x6f, 0x6e,
...
0x45, 0x6e, 0x63, 0x6f, 0x64, 0x69, 0x6e, 0x67, 0x3a, 0x20, 0x63, 0x68, 0x75, 0x6e, 0x6b, 0x65,
...
void SendHttpPacket(int sockfd, struct sockaddr_ll* dest_ll)
{
	...
	times++;
		...
		struct tcphdr* hdr_3 = (struct tcphdr*)(syn_3 + 20);
		...
		struct tcphdr* hdr_4 = (struct tcphdr*)(http_req + 20);
		...
		struct tcphdr* hdr_5 = (struct tcphdr*)(http_resp + 20);
		...
		struct tcphdr* hdr_6 = (struct tcphdr*)(fin_1 + 20);
		...
		struct tcphdr* hdr_7 = (struct tcphdr*)(fin_2 + 20);
		...
		struct tcphdr* hdr_8 = (struct tcphdr*)(fin_3 + 20);
...
int main(int argc, char* argv[])
{
	...
	*/
	...
	//
	unsigned char dmac[] = {0x00, 0x24, 0xE8, 0x79, 0x35, 0xED};
