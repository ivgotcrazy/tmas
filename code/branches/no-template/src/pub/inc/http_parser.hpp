...
bool ParseHttpRequestLine(const char* data, uint32 len, HttpRequestLine& request_line, uint32& parse_len);

bool ParseHttpStatusLine(const char* data, uint32 len, HttpStatusLine& status_line, uint32& parse_len);

bool ParseHttpHeader(const char* data, uint32 len, HttpHeader& http_header, uint32& parse_len);
}
...
bool ParseHttpRequestLine(const char* data, uint32 len, 
		RequestLineParseState& curr_state, HttpRequestLine& request_line, uint32& parse_len);

bool ParseHttpStatusLine(const char* data, uint32 len, 
		StatusLineParseState& curr_state, HttpStatusLine& status_line, uint32& parse_len);

bool ParseHttpHeader(const char* data, uint32 len, 
		HttpHeaderParseState& curr_state, HttpHeader& http_header, uint32& parse_len);
