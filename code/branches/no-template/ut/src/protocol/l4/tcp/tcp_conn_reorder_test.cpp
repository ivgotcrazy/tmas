...
void TcpConnReorderTest::AccomplishTcp3WHS()
{
	...
	ASSERT_EQ(PI_RET_STOP, tcp_conn_reorder_->Process(MSG_PKT, void_first_pkt));
	...
	ASSERT_EQ(PI_RET_STOP, tcp_conn_reorder_->Process(MSG_PKT, void_second_pkt));
	...
	ASSERT_EQ(PI_RET_STOP, tcp_conn_reorder_->Process(MSG_PKT, void_third_pkt));
...
TEST_F(TcpConnReorderTest, Process_Normal_1)
{
	...
	ASSERT_EQ(PI_RET_STOP, tcp_conn_reorder_->Process(MSG_PKT, void_request_1));
	...
	ASSERT_EQ(PI_RET_STOP, tcp_conn_reorder_->Process(MSG_PKT, void_response_1));
...
TEST_F(TcpConnReorderTest, Process_Disorder_2)
{
	...
	ASSERT_EQ(PI_RET_STOP, tcp_conn_reorder_->Process(MSG_PKT, void_response));
	...
	ASSERT_EQ(PI_RET_STOP, tcp_conn_reorder_->Process(MSG_PKT, void_request));
...
TEST_F(TcpConnReorderTest, Process_Disorder_3)
{
	...
	ASSERT_EQ(PI_RET_STOP, tcp_conn_reorder_->Process(MSG_PKT, void_request_2));
...
TEST_F(TcpConnReorderTest, Process_Disorder_4)
{
	...
	ASSERT_EQ(PI_RET_STOP, tcp_conn_reorder_->Process(MSG_PKT, void_response_2));
	...
	ASSERT_EQ(PI_RET_STOP, tcp_conn_reorder_->Process(MSG_PKT, void_request_3));
