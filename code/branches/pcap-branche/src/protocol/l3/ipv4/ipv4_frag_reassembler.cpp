 ...
 *   描述 创建
 ----------------------------------------------------------------------------*/
Ipv4FragReassembler::Ipv4FragReassembler(Ipv4MonitorType* monitor, const PktMsgSP& pkt_msg)
 ...
 *   描述 创建
 ----------------------------------------------------------------------------*/
void Ipv4FragReassembler::ProcessFragPkt(const PktMsgSP& pkt_msg)
{
 ...
 *   描述 创建
 ----------------------------------------------------------------------------*/
bool Ipv4FragReassembler::InsertPktFrag(const PktMsgSP& pkt_msg)
{
 ...
 *   描述 创建
 ----------------------------------------------------------------------------*/
bool Ipv4FragReassembler::ProcFrontPktFrag(const PktMsgSP& pkt_msg)
{
	// 第一次收到首分片
 ...
 *   描述 创建
 ----------------------------------------------------------------------------*/
bool Ipv4FragReassembler::ProcRearPktFrag(const PktMsgSP& pkt_msg)
{
	// 第一次收到最后一个分片
 ...
 *   描述 创建
 ----------------------------------------------------------------------------*/
void Ipv4FragReassembler::DoInsertPktFrag(const PktMsgSP& pkt_msg)
{
 ...
 *   描述 创建
 ----------------------------------------------------------------------------*/
void Ipv4FragReassembler::ProcFirstInPktFrag(const PktMsgSP& pkt_msg)
{
	meat_ = pkt_msg->l3_pkt_info.l3_data_len;
...
void Ipv4FragReassembler::ReasmPktFrags()
{
	...
	LOG(ERROR) << "Reassemble packet";

	// 当做刚捕获的报文进行处理
	PktDispatcherType::GetInstance()->ProcessPktEntry(pkt);
