/*#############################################################################
 * 文件名   : tcp_conn_analyzer_test.hpp
 * 创建人   : tom_liu
 * 创建时间 : 2014年03月5日
 * 文件描述 : TcpConnAnalyzer 声明
 * 版权声明 : Copyright (c) 2014 BroadInter. All rights reserved.
 * ##########################################################################*/
#ifndef BROADINTER_TCP_CONN_ANALYZER_TEST
#define BROADINTER_TCP_CONN_ANALYZER_TEST
...
protected:
	...
	PktMsgSP ConstructRstPkt();

	PktMsgSP ConstructContentPkt();
